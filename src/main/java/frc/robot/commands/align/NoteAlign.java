...
public class NoteAlign extends Command {
	 ...
	 * @param driveSubsystem Drive Subsystem with alignment functions
	 * @param timeAlign the amount of time that the robot aligns with the tag
	 */
	public NoteAlign(DriveFSMSystem driveSubsystem, double timeAlign) {
